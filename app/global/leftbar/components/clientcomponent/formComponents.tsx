import {AddServer} from "@/app/global/leftbar/components/action/action";

interface Props {
    SetState: ()=> void;
}

function FormComponent({SetState}: Props){
    return (<div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
        <div className="w-full max-w-md rounded-lg bg-[#313338] shadow-2xl">
            ...
            <form className="px-6 pb-6" action={AddServer} onSubmit={SetState}>
                <div className="mb-6">
                        <span
